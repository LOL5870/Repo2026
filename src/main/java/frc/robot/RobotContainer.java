...
// opXbox.povRight().whileTrue(new ElevatorSetpoint(elevator, 50).alongWith(new ArmSetpoint(arm, 30))).onFalse(new GripperClose(arm));
    // driverXbox.x().whileTrue(new InstantCommand(() -> elevator.elevatorUp())).onFalse(new InstantCommand(() -> elevator.elevatorStop()));
    // driverXbox.y().whileTrue(new InstantCommand(() -> elevator.elevatorDown())).onFalse(new InstantCommand(() -> elevator.elevatorStop()));
